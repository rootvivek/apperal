        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products/mens-clothing" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Men's Clothing
                </Link>
              </li>
              <li>
                <Link href="/products/womens-clothing" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Women's Clothing
                </Link>
              </li>
              <li>
                <Link href="/products/accessories" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Accessories
                </Link>
              </li>
              <li>
                <Link href="/products/electronics" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Electronics
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">support@apperal.com</p>
              </div>
            </div>
          </div>
        </div>
