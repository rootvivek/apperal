    ...
    <div className="hidden sm:flex flex-1 mx-4 lg:mx-8">
      <form onSubmit={handleSearch} className="relative w-full">
        <input
          ...
          value={searchQuery}
          onChange={handleInputChange}
          className="w-full py-2 pl-10 pr-4 text-gray-700 bg-gray-100 border border-gray-300 rounded-[999px] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
        />
