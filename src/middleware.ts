...
export function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "style-src 'self' 'unsafe-inline' https://www.gstatic.com https://hcaptcha.com https://*.hcaptcha.com",
    "style-src-elem 'self' 'unsafe-inline' https://www.gstatic.com https://hcaptcha.com https://*.hcaptcha.com",
