...
// >= 1440px: 5 columns
// >= 1920px: 6 columns
export const PRODUCT_GRID_CLASSES_RESPONSIVE = "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 xl-custom:grid-cols-5 3xl:grid-cols-6 gap-1";
...
export const PRODUCT_GRID_CLASSES_SMALL_GAP = "grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-1.5 sm:gap-2";
