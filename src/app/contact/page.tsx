            ...
            <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <svg className="h-6 w-6 text-[#4736FE] mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mt-1">
                      <a href="tel:+919876543210" className="hover:text-[#4736FE] transition-colors">
                        +91 98765 43210
                      </a>
                    </p>
                  </div>
