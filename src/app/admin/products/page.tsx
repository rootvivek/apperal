    ...
    <AdminGuard>
      ...
      <div className="flex flex-col h-full space-y-1">
        ...
        <div className="flex justify-between items-center flex-shrink-0">
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-gray-900">Products</h1>
          ...
          <Link
            ...
            className="inline-flex items-center px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
          >
            <span className="hidden sm:inline">➕ </span>Add New
          </Link>
        </div>
              ...
              <div className="flex-1 flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  {!searchTerm && filterCategory === 'all' && (
                    <Link
                      href="/admin/products/new"
                      className="inline-flex items-center px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 border border-transparent rounded-md shadow-sm text-xs sm:text-sm font-medium text-white bg-blue-600 hover:bg-blue-700"
                    >
                      <span className="hidden sm:inline">➕ </span>Add Your First Product
                    </Link>
                  )}
                </div>
              </div>
                    ...
                    {filteredProducts.map((product) => (
                      <tr key={product.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-1 py-0.5 whitespace-nowrap">
                              <div className="flex items-center gap-1">
                                ...
                                {product.is_active === false && (
                                  <span className="px-1 py-0 text-xs font-semibold rounded bg-gray-500 text-white">
                                    Inactive
                                  </span>
                                )}
                              </div>
                        ...
                        <td className="px-1 py-0.5 whitespace-nowrap text-xs text-gray-500">
                          <div className="flex items-center gap-1">
                            <code className="px-0.5 py-0 bg-gray-100 rounded text-gray-700 text-xs">
                        ...
                        <td className="px-1 py-0.5 whitespace-nowrap text-xs text-gray-900">
                        ...
                        <td className="px-1 py-0.5 whitespace-nowrap">
                          <button
                            ...
                            disabled={loading}
                            className={`inline-flex px-1 py-0 text-xs font-semibold rounded transition-colors ${
                              product.is_active
                        ...
                        <td className="px-1 py-0.5 whitespace-nowrap text-xs font-medium">
